...
normal_spendings = []
high_spendings = []
for spends in spendings:
    if spends < 1000.0:
        low_spendings.append(spends)
    elif spends > 1000.0 and spends <= 2500.0:
        normal_spendings.append(spends)
    elif spends >2500.0:
        high_spendings.append(spends)

print('Numbers of months with low spendings:' + str(low_spendings), ' normal spendings:' + str(normal_spendings), ' high spendings:' + str(high_spendings) + '.', sep=',')
